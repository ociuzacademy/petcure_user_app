...
class PrescriptionsService {
  static Future<PrescriptionListModel> getPrescriptions({
    required String userId,
  }) async {
    debugPrint('PrescriptionsService: userId - $userId');
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        final response = PrescriptionListModel.fromJson(decoded);
      ...
      debugPrint('PrescriptionsService: Request timeout - $e');
      throw Exception(
