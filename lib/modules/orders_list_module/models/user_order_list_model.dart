...
//
//     final userOrderListModel = userOrderListModelFromJson(jsonString);

import 'dart:convert';

List<UserOrderListModel> userOrderListModelFromJson(String str) =>
    List<UserOrderListModel>.from(
      json.decode(str).map((x) => UserOrderListModel.fromJson(x)),
    );

String userOrderListModelToJson(List<UserOrderListModel> data) =>
...
class UserOrderListModel {
  ...
  factory UserOrderListModel.fromJson(Map<String, dynamic> json) =>
      UserOrderListModel(
        id: json['id'],
        user: json['user'],
